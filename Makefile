...
help:
	...
	@echo "  package  independent Forgejo source artifact"
...
package:
	...
	@tar --exclude-vcs --exclude='./.github' --exclude='./dist' \
	     ...
	     -czf "dist/forgejo-$(VERSION).tar.gz" \
	     -C "$(REPOSITORY_ROOT)" .
	@echo "Wrote dist/forgejo-$(VERSION).tar.gz"
