...
the same-host runner boundary.
Integration tests exercise the CLI. The upstream sync separately runs
shared family conformance before publishing. Root smoke tests verify
